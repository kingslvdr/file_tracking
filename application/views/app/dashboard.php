...
<div class="wrapper">
  ...
  <!-- <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="<?php {echo URL;} ?>public/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div> -->
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?php {echo URL;} ?>public/dist/img/icon-512.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<script src="<?php {echo URL;} ?>public/dist/js/pages/dashboard2.js"></script>
</body>
</html>
